...
class TestParser(unittest.TestCase):
    def test_jan_2020(self):
        ...
        with open("./output_test/test_parser/expected_2020.json", "r") as fp:
            expected_2020 = json.load(fp)

        files = [
            "./output_test/test_parser/membros-ativos-contracheque-01-2020.ods",
            "./output_test/test_parser/membros-ativos-verbas-indenizatorias-01-2020.ods",
        ]
    ...
    def test_jan_2018(self):
        self.maxDiff = None
        # Json com a saida esperada
        with open("./output_test/test_parser/expected_2018.json", "r") as fp:
            expected_2018 = json.load(fp)

        files = ["./output_test/test_parser/membros-ativos-contracheque-01-2018.ods"]
